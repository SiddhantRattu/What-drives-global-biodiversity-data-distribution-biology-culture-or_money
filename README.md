...
```
.
├── scripts/                # Analysis pipeline and auxiliary tools
│   ├── 00_setup_libraries.R
│   ├── 01_data_cleaning.R
│   ├── ... (numbered pipeline)
│   └── Final_output.R      # Data aggregation for final reporting
├── data/
│   ├── raw/                # Immutable source data (CSVs, Shapefiles)
│   └── processed/          # Cleaned intermediate datasets
├── docs/                   # Data dictionaries and column definitions
├── output/                 # Generated figures and tables
├── renv/                   # Project library (dependency management)
├── drafts/                 # Archived code and experiments
└── README.md
```
